  ...
  return (
    ...
    >
      ...
      <nav style={{ flex: 1, padding: "8px", overflowY: "auto" }}>
        {filteredNav.map((item) => {
          ...
          if (item.type === "group") {
            ...
            const hasActive = filteredChildren.some(
              (c: any) => c.href === pathname,
            );
                        ...
                        <Link
                          ...
                          style={{
                            ...
                            borderLeft: collapsed
                              ? "none"
                              : `2px solid ${active ? "var(--cyan)" : "var(--border)"}`,
                          }}
                        >
                          <span style={{ fontSize: collapsed ? 18 : 14 }}>
                            {child.icon}
                          </span>
      ...
      <div
        style={{
          padding: "8px",
          paddingBottom: "24px", // ← agrega esto
